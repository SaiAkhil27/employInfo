...
public class eproject extends JFrame implements ActionListener {

  // Define UI components
  private JTextField nameTextField, idTextField, departmentTextField, salaryTextField, companyTextField;
  private JButton addButton, viewButton, clearButton, exitButton;
  private JTextArea employeeTextArea;

  // Constructor
  public eproject() {
    super("Employee Management Project");
    ...
    JLabel companyLabel = new JLabel("Email: ");
    ...
    // Create text area
    employeeTextArea = new JTextArea(5, 30);
  ...
  private void addEmployee() {
    ...
    employeeTextArea.append("Company: " + company + "\n\n");
    // Clear input fields
